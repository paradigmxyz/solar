...
mod lower_aggregates;
mod lower_alloc;
mod lower_dispatch;
mod lower_evm_shaped;
mod lower_mapping_slots;
mod lower_memory_objects;
mod lower_slices;
mod memory_dse;
mod outline_reverts;
mod pre;
...
pub(crate) use evm_inst_schedule::EvmInstSchedulePass;
...
pub(crate) use lower_aggregates::LowerAggregatesPass;
...
pub(crate) use lower_memory_objects::LowerMemoryObjectsPass;
