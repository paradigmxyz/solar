...
impl PhaseSet {
    ...
    pub(crate) const THROUGH_MEMORY_LOWERED: Self = Self::through(MirPhase::Lowered);
...
enum InstKind {
    ...
    Self::ICall { .. } => { mnemonic: "icall", result: Custom, phases: PhaseSet::ALL, effect: ICall, traits: OpTraits::NONE, side_effects: true, category: None },
