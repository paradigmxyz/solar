...
mod tests {
    ...
    fn propagates_captures_and_fmp_resets() {
        ...
        let mut reader = Function::new(Ident::with_dummy_span(sym::memory_read));
        {
            ...
            let ptr = builder.add_param(MirType::Word);
            let value = builder.mload(ptr);
            builder.ret([value]);
        }
        reader.set_return_type(MirType::Word);
        ...
        returning.set_return_type(MirType::Word);
        ...
        obfuscated.set_return_type(MirType::Word);
