...
impl<'gcx, 'ctx> FunctionLowerer<'gcx, 'ctx> {
    ...
    fn calldata_value_position(
        ...
        if validate_bounds {
            ...
            self.builder.revert_if_reason(invalid, RevertReason::InvalidCalldataTailOffset);
        }
        Some(value_pos)
    }
    ...
    fn check_calldata_range(&mut self, start: ValueId, size: ValueId) {
        ...
        self.builder.revert_if_reason(invalid, RevertReason::CalldataTailTooShort);
    }
    ...
    fn validate_calldata_dynamic_tail(
        ...
        self.builder.revert_if_reason(out_of_bounds, RevertReason::CalldataTailTooShort);
    }
    ...
    fn validate_calldata_length(&mut self, length: ValueId) {
        ...
        self.builder.revert_if_reason(too_large, RevertReason::InvalidCalldataTailLength);
    }
