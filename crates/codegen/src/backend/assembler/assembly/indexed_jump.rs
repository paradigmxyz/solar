...
pub(in crate::backend) fn indexed_jump_target_width_bound(
    evm_version: EvmVersion,
    is_constructor: bool,
) -> usize {
...
pub(in crate::backend) fn estimated_indexed_jump_code_size(
    table_len: usize,
    target_width: usize,
    base_width: usize,
    evm_version: EvmVersion,
...
pub(in crate::backend) fn packs_indexed_jump(
    table_len: usize,
    target_width: usize,
    evm_version: EvmVersion,
) -> bool {
...
mod tests {
    ...
    use crate::{
        backend::{
            ...
            evm::ir::{Block, Instruction, Terminator, TerminatorKind},
        },
