...
pub(crate) fn render(gcx: Gcx<'_>, item_id: hir::ItemId) -> Option<RenderedDocumentation> {
...
fn append_documentation(output: &mut String, documentation: &NatSpecDocumentation) {
