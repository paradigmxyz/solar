...
impl Parse for Newtype {
    fn parse(input: ParseStream<'_>) -> Result<Self> {
        ...
        let mut ord = false;
        let mut gate_cfg = quote! { #[cfg(feature = "nightly")] };
        let mut gate_meta = quote! { feature = "nightly" };
        ...
        Ok(Self(quote! {
            ...
            #[cfg_attr(#gate_meta, rustc_layout_scalar_valid_range_end(#max))]
            #[cfg_attr(#gate_meta, rustc_pass_by_value)]
            #vis struct #name {
                private: u32,
            }
