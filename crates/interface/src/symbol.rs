...
symbols! {
    ...
    Symbols {
        ...
        core_array_group_sort_inner,
        core_array_group_sum,
        core_array_set_difference,
        core_array_set_difference_address,
        core_array_set_difference_signed,
        core_array_set_intersection,
        core_array_set_intersection_address,
        core_array_set_intersection_signed,
        core_array_set_union,
        core_array_set_union_address,
        core_array_set_union_signed,
        core_base64_decode,
        core_base64_decode_any,
        core_base64_decode_imap,
        core_bytes_equals_at,
        core_hex_digits,
        core_hex_encode,
        core_hex_fixed,
        core_string_escape_html,
        core_string_escape_json,
        core_string_escape_json_quotable,
        core_string_index_of,
        core_string_last_index_of,
        core_string_uri_component,
        creationCode,
        custom_error,
        data,
        data_copy,
