...
contract MappingBytesValues {
    ...
    // CHECK: icall @store_storage_bytes, 0, [[SLOT]], arg1
    ...
    // CHECK: icall @store_storage_bytes, 0, [[INNER]], arg2
    ...
    // CHECK-LABEL: fn @get{{[( ]}}
    // CHECK: [[SLOT:v[0-9]+]] = mapping_slot arg0, 0
    // CHECK: [[VALUE:v[0-9]+]] = icall @load_storage_bytes{{.*}}, 1, [[SLOT]]
    // CHECK: ret [[VALUE]]
    ...
    // CHECK: [[OUTER:v[0-9]+]] = mapping_slot arg0, 1
    // CHECK: [[INNER:v[0-9]+]] = mapping_slot arg1, [[OUTER]]
    // CHECK: [[VALUE:v[0-9]+]] = icall @load_storage_bytes{{.*}}, 1, [[INNER]]
    // CHECK: ret [[VALUE]]
