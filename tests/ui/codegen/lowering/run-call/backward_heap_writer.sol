...
// Subtracting from the free-memory pointer can reach live compiler-owned homes.
// The store must not change the values retained across it.
contract BackwardHeapWriter {
