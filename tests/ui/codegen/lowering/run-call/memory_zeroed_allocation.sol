...
//@ run-call-fail: readDynamic 5, 5 => Panic(0x32)
//@ run-call: readNested 2, 4, 1, 3 => 0
//@ run-call-fail: readNested 2, 4, 1, 4 => Panic(0x32)
//@ run-call: readFixed 2 => 0
//@ run-call-fail: readFixed 3 => Panic(0x32)
//@ run-call: readStatic 2, 1 => 0
//@ run-call-fail: readStatic 2, 2 => Panic(0x32)
