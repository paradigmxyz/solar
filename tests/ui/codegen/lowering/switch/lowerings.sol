...
//@[linear_gas] compile-flags: -Zcodegen -O gas -Zswitch-lowering=linear -Zdump=evm-ir-runtime
//@[linear_gas] filecheck: --check-prefix=LINEAR
//@[linear_size] compile-flags: -Zcodegen -O size -Zswitch-lowering=linear -Zdump=evm-ir-runtime
//@[linear_size] filecheck: --check-prefix=LINEAR
//@[binary_gas] compile-flags: -Zcodegen -O gas -Zswitch-lowering=binary -Zdump=evm-ir-runtime
//@[binary_gas] filecheck: --check-prefix=BINARY
//@[binary_size] compile-flags: -Zcodegen -O size -Zswitch-lowering=binary -Zdump=evm-ir-runtime
//@[binary_size] filecheck: --check-prefix=BINARY
//@[buckets_gas] compile-flags: -Zcodegen -O gas -Zswitch-lowering=buckets -Zdump=evm-ir-runtime
//@[buckets_gas] filecheck: --check-prefix=BUCKETSGAS
//@[buckets_size] compile-flags: -Zcodegen -O size -Zswitch-lowering=buckets -Zdump=evm-ir-runtime
//@[buckets_size] filecheck: --check-prefix=BUCKETSSIZE
//@[dense_gas] compile-flags: -Zcodegen -O gas -Zswitch-lowering=dense -Zdump=evm-ir-runtime
//@[dense_gas] filecheck: --check-prefix=DENSE
//@[dense_size] compile-flags: -Zcodegen -O size -Zswitch-lowering=dense -Zdump=evm-ir-runtime
//@[dense_size] filecheck: --check-prefix=DENSE
//@[perfect_gas] compile-flags: -Zcodegen -O gas -Zswitch-lowering=perfect -Zdump=evm-ir-runtime
//@[perfect_gas] filecheck: --check-prefix=PERFECTGAS
//@[perfect_size] compile-flags: -Zcodegen -O size -Zswitch-lowering=perfect -Zdump=evm-ir-runtime
