...
//@[homestead] compile-flags: --evm-version homestead -Zdump=mir
//@[byzantium] compile-flags: --evm-version byzantium -Zdump=mir
//@[constantinople] compile-flags: --evm-version constantinople -Zdump=mir
//@[osaka] compile-flags: --evm-version osaka -Zdump=mir
