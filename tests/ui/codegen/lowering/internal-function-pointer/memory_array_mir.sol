...
contract FunctionPointerMemoryArray {
    ...
    // CHECK: eq arg0, [[A]]
    // CHECK: internal_call @arrayA.8, 1, arg1
    // CHECK: eq arg0, [[B]]
    // CHECK: internal_call @arrayB.9, 1, arg1
    // CHECK: eq arg0, [[C]]
    // CHECK: internal_call @arrayC.10, 1, arg1
    // CHECK: eq arg0, [[D]]
    // CHECK: internal_call @arrayD.11, 1, arg1
    // CHECK: eq arg0, [[E]]
    // CHECK: internal_call @arrayE.12, 1, arg1
