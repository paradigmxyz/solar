...
contract FunctionPointerMemoryArray {
    ...
    // CHECK: eq arg0, [[A]]
    // CHECK: internal_call @arrayA.{{[0-9]+}}, 1, arg1
    // CHECK: eq arg0, [[B]]
    // CHECK: internal_call @arrayB.{{[0-9]+}}, 1, arg1
    // CHECK: eq arg0, [[C]]
    // CHECK: internal_call @arrayC.{{[0-9]+}}, 1, arg1
    // CHECK: eq arg0, [[D]]
    // CHECK: internal_call @arrayD.{{[0-9]+}}, 1, arg1
    // CHECK: eq arg0, [[E]]
    // CHECK: internal_call @arrayE.{{[0-9]+}}, 1, arg1
