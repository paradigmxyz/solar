...
contract C {
    function f(
        ...
        address b20_from_p = bytes20(p); //~ ERROR: invalid explicit type conversion
        address a6 = payable(b20); //~ ERROR: invalid explicit type conversion
        uint160 u160_from_p = uint160(p); //~ ERROR: invalid explicit type conversion
        address a7 = payable(u160); //~ ERROR: invalid explicit type conversion
    }
}
